...
function Quiz(props){
    ...
    return(
    <div className='block-frontend-mcp' style={{backgroundColor:props.bgColor , textAlign: props.aligment}}>
        <p>{props.question}</p>
        <ul>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"  className="bi bi-emoji-laughing" viewBox="0 0 16 16">
